...
function ExportEnvs(secretId, secretKey, securityToken, region) {
  ...
  exportVariable("TENCENTCLOUD_SECRET_ID", secretId);
  exportVariable("TENCENTCLOUD_SECRET_KEY", secretKey);
  exportVariable("TENCENTCLOUD_TOKEN", securityToken);
  exportVariable("TENCENTCLOUD_SECURITY_TOKEN", securityToken);
  exportVariable("TENCENTCLOUD_REGION", region);
}
